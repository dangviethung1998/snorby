# -*- encoding: utf-8 -*-
# stub: dm-aggregates 1.2.0 ruby lib

Gem::Specification.new do |s|
  s.name = "dm-aggregates".freeze
  s.version = "1.2.0"
  ...
  s.date = "2011-10-09"
  s.description = "DataMapper plugin providing support for aggregates on collections".freeze
  s.email = "foysavas [a] gmail [d] com".freeze
  s.extra_rdoc_files = ["LICENSE".freeze, "README.rdoc".freeze]
  s.files = ["LICENSE".freeze, "README.rdoc".freeze]
  s.homepage = "http://github.com/datamapper/dm-aggregates".freeze
  s.rubyforge_project = "datamapper".freeze
  s.rubygems_version = "2.7.7".freeze
  s.summary = "DataMapper plugin providing support for aggregates on collections".freeze
