# -*- encoding: utf-8 -*-
# stub: dm-ar-finders 1.2.0 ruby lib

Gem::Specification.new do |s|
  s.name = "dm-ar-finders".freeze
  s.version = "1.2.0"

  s.required_rubygems_version = Gem::Requirement.new(">= 0".freeze) if s.respond_to? :required_rubygems_version=
  s.require_paths = ["lib".freeze]
  s.authors = ["John W Higgins".freeze]
  s.date = "2011-10-09"
  s.description = "DataMapper plugin providing ActiveRecord-style finders".freeze
  s.email = "john [a] wishVPS [d] com".freeze
  s.extra_rdoc_files = ["LICENSE".freeze, "README.rdoc".freeze]
  s.files = ["LICENSE".freeze, "README.rdoc".freeze]
  s.homepage = "http://github.com/datamapper/dm-ar-finders".freeze
  s.rubyforge_project = "datamapper".freeze
  s.rubygems_version = "2.7.7".freeze
  s.summary = "DataMapper plugin providing ActiveRecord-style finders".freeze
