...
Gem::Specification.new do |s|
  s.name = "dm-mysql-adapter".freeze
  s.version = "1.2.0"
  ...
  s.date = "2011-10-09"
  s.description = "MySQL Adapter for DataMapper".freeze
  s.email = "dan.kubb@gmail.com".freeze
  s.extra_rdoc_files = ["LICENSE".freeze, "README.rdoc".freeze]
  s.files = ["LICENSE".freeze, "README.rdoc".freeze]
  s.homepage = "http://github.com/datamapper/dm-mysql-adapter".freeze
  s.rubyforge_project = "datamapper".freeze
  s.rubygems_version = "2.7.7".freeze
  s.summary = "MySQL Adapter for DataMapper".freeze
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      s.add_runtime_dependency(%q<do_mysql>.freeze, ["~> 0.10.6"])
      ...
      s.add_dependency(%q<do_mysql>.freeze, ["~> 0.10.6"])
