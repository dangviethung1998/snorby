# -*- encoding: utf-8 -*-
# stub: dm-rails 1.2.1 ruby lib

Gem::Specification.new do |s|
  s.name = "dm-rails".freeze
  s.version = "1.2.1"

  s.required_rubygems_version = Gem::Requirement.new(">= 0".freeze) if s.respond_to? :required_rubygems_version=
  s.require_paths = ["lib".freeze]
  s.authors = ["Martin Gamsjaeger (snusnu)".freeze, "Dan Kubb".freeze]
  s.date = "2012-02-15"
  s.description = "Integrate DataMapper with Rails 3".freeze
  s.email = "gamsnjaga@gmail.com".freeze
  s.extra_rdoc_files = ["LICENSE".freeze, "README.rdoc".freeze]
  s.files = ["LICENSE".freeze, "README.rdoc".freeze]
  s.homepage = "http://github.com/datamapper/dm-rails".freeze
  s.rubyforge_project = "datamapper".freeze
  s.rubygems_version = "2.7.7".freeze
  s.summary = "Use DataMapper with Rails 3".freeze
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_runtime_dependency(%q<dm-active_model>.freeze, ["~> 1.2.0"])
      ...
      s.add_dependency(%q<dm-active_model>.freeze, ["~> 1.2.0"])
