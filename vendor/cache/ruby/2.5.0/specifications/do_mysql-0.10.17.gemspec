# -*- encoding: utf-8 -*-
# stub: do_mysql 0.10.17 ruby lib
# stub: ext/do_mysql/extconf.rb

Gem::Specification.new do |s|
  s.name = "do_mysql".freeze
  s.version = "0.10.17"
  ...
  s.date = "2016-01-24"
  s.description = "Implements the DataObjects API for MySQL".freeze
  s.email = "d.bussink@gmail.com".freeze
  s.extensions = ["ext/do_mysql/extconf.rb".freeze]
  s.extra_rdoc_files = ["ChangeLog.markdown".freeze, "LICENSE".freeze, "README.markdown".freeze]
  s.files = ["ChangeLog.markdown".freeze, "LICENSE".freeze, "README.markdown".freeze, "ext/do_mysql/extconf.rb".freeze]
  s.rubyforge_project = "dorb".freeze
  s.rubygems_version = "2.7.7".freeze
  s.summary = "DataObjects MySQL Driver".freeze
